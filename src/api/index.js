...
API.interceptors.request.use((config) => {
    ...
    if (token) {
      config.headers.Authorization = `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjE5NTIwMDEiLCJyb2xlIjoic3R1ZGVudCIsInVzZXJuYW1lIjoic3R1ZGVudDEiLCJzdHVkZW50SWQiOiIxOTUyMDAxIiwiaWF0IjoxNzQ2NDI5Nzk4LCJleHAiOjE3NDY1MTYxOTh9.fr52cI6ajDUFhUzQfvIrR4reL5l6jKYNKlq8JeyUFQM`;
    }
    return config});
